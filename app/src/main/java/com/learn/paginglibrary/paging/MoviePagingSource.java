package com.learn.paginglibrary.paging;
...
import com.learn.paginglibrary.api.APIClient;
...
public class MoviePagingSource extends RxPagingSource<Integer, Movie> {
    ...
    public Single<LoadResult<Integer, Movie>> loadSingle(@NonNull LoadParams<Integer> loadParams) {
        try{
            ...
            return APIClient.getApiInterface().getMovieByPage(page).subscribeOn(Schedulers.io())
                    .map(MovieRespone::getMovieList)
